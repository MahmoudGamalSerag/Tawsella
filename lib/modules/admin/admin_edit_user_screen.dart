  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AdminCubit, AdminStates>(
      listener: (context, state) {
        if(state is AdminUserUpdateSuccessState)
        {
          showToast(text: "Updated", state: ToastStates.SUCCESS);
        }
      },
      builder: (context, state) {
        var userModel = AdminCubit.get(context).profileOwner;
        var profileImage = AdminCubit.get(context).profileImage;
        var coverImage = AdminCubit.get(context).coverImage;
        ...
        return Scaffold(
              ...
              actions: [
                defaultTextButton(
                  function: () {
                    ...
                    {
                      AdminCubit.get(context).updateUser(
                          name: nameController.text,
                          phone: phoneController.text,
                          address: addressController.text,email:emailController.text
                      );}
                  },
                  text: 'Update',
                ),
          ...
          body: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                children: [
                  if (state is AdminUserUpdateLoadingState)
                  ...
                  if (AdminCubit.get(context).profileImage != null ||
                      AdminCubit.get(context).coverImage != null)
                    Row(
                      children: [
                        if (AdminCubit.get(context).profileImage != null)
                          Expanded(
                        ...
                        if (AdminCubit.get(context).coverImage != null)
                          Expanded(
                            child: Column(
                              children: [
                                defaultButton(
                                  function: ()
                                  {
                                    AdminCubit.get(context).uploadCoverImage(
                                      name: nameController.text,
                                      phone: phoneController.text,
                                      address: addressController.text,
                                      email: emailController.text
