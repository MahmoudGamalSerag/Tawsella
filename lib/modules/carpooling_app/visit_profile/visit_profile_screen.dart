            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: defaultButton(
                            function: (){
                              navigateTo(context, ChatDetailsScreen(userModel: profileOwner));
                            },
                            text: "Send Message",
                            radius: 20.0,),
                  ...
                  SizedBox(height: 40,),
                  ConditionalBuilder(
                    condition: CarpoolingCubit.get(context).visitposts.length > 0 && CarpoolingCubit.get(context).profileOwner != null,
                      ...
                      child: Column(
                        ...
                        [
                          ListView.separated(
                            ...
                            itemBuilder: (context, index) => buildPostItem(CarpoolingCubit.get(context).visitposts[index],profileOwner,context, index),
                            separatorBuilder: (context, index) => SizedBox(
                              height: 8.0,
                            ),
                            itemCount: CarpoolingCubit.get(context).visitposts.length,
                          ),
                          SizedBox(
                            height: 8.0,
                          ),
